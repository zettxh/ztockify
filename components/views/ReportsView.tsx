      ...
      {Object.keys(reportData).length > 0 ? Object.entries(reportData).map(([category, items]) => (
        <div key={category}>
          ...
          <div className="border-t border-slate-200 dark:border-slate-700">
            <div className="grid grid-cols-2 gap-x-4 px-4 py-2 bg-slate-50 dark:bg-slate-700/50">
            ...
            {items.map(item => (
              <div key={item.size} className="grid grid-cols-2 gap-x-4 px-4 py-3 border-t border-slate-200 dark:border-slate-700">
